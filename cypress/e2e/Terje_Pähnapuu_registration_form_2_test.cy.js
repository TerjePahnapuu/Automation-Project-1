...
describe('Section 1: Functional tests', () => {
    ...
    it('User can use only same both first and validation passwords', () => {
        ...
        cy.get('#email').type('master@meil.ee')
        cy.get('input[name="name"]').type('Iam')
        cy.get('#lastName').type('Master')
        cy.get('[data-testid="phoneNumberTestId"]').type('65747484746')
        cy.get('#password').type('abcdef')
        cy.get('#confirm').type('edcba')
    ...
    it('User can not submit form with email missing', () => {
        inputValidData('johnDoe')
        cy.get('#email').clear()
        cy.get('h2').contains('Password').click()
        cy.get('.submit_button').should('be.disabled')
    ...
    it('User can not submit form with last name missing', () => {
        inputValidData('johnDoe')
