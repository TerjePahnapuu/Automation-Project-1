 ...
 */
/// 02.02.2024
describe('This is first test suite, Terje Pähnapuu', () => {
    it('User can submit data only when valid mandatory values are added', () => {
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        cy.get('input[name="firstName"]').type('terje')
        cy.get('input[name="lastName"]').type('pähnapuu')
    ...
    */
    ...
    it('User cannot add letters to phone number', () => {
        ...
        cy.get('[data-testid="phoneNumberTestId"]').type('anything')
        cy.get('input[name="firstName"]').type('terje')
        cy.get('input[name="lastName"]').type('pähnapuu')
        cy.get('input[name="password"]').type('abcd')
        cy.get('[name="confirm"]').type('abcd')
